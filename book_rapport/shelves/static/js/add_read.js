...
function handleResponse(response) {
  ...
  for (var i = 0; i < results_count; i++) {
    ...
    isbn13    = response.items[i].volumeInfo.industryIdentifiers[1].identifier,
    isbn10    = response.items[i].volumeInfo.industryIdentifiers[0].identifier;
    ...
    var add_button = $('<input type="button" id="add-book" value="Add Book"/>');
...
$('input#add-book').on('click', function(){
